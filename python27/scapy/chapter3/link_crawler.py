...
def link_crawler(seed_url, link_regex=None, delay=5, user_agent='wswp', max_urls=-1,
                 max_depth=1, proxy=None, num_retries=1, cache=None):
    ...
    download = Downloader(delay=delay, user_agent=user_agent, proxies=proxy, num_retries=num_retries, cache=cache)
